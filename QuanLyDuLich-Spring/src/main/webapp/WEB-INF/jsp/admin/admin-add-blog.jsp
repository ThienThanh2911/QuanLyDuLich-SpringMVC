...
<div class="main-panel">
    ...
    <nav class="navbar navbar-expand-lg " color-on-scroll="500">
        <div class="container-fluid">
            <a class="navbar-brand" style="margin-top: 0" href="#pablo"> Add Blog <i class="nc-icon nc-palette"></i></a>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form:form method="post" action="${action}" modelAttribute="blog" enctype="multipart/form-data">
                    ...
                    <button onclick="notifi()" type="submit" class="btn btn-info btn-fill pull-right">Add Blog</button>
                    <div class="clearfix"></div>
                </form:form>
                <script>
                    function notifi(){
                        demo.showNotification("fa fa-plus", `Bạn đã thêm Blog thành công`, 2)
                    }
                </script>
            </div>
        </div>
