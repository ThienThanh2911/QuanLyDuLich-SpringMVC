                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form:form method="post" action="${action}" modelAttribute="tour" enctype="multipart/form-data">
                                ...
                                <button onclick="notifi()" type="submit" class="btn btn-info btn-fill pull-right">Update Tour</button>
                    ...
                    <div class="card card-user">
                        <div class="card-body">
                            ...
                            <p class="description text-center">
                                ...
                                <br>Phương tiện di chuyển: ${tour.vehicle}
                            </p>
                        </div>
                        <hr>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="startDate" name="startDate" cssClass="form-control"/>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Finish Date</label>
                                        <input type="date" id="finishDate" name="finishDate" cssClass="form-control"/>
                                    </div>
                                </div>
                            </div>
