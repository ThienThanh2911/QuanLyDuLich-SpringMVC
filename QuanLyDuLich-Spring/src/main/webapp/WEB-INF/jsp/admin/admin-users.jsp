...
<div class="main-panel">
    ...
    <nav class="navbar navbar-expand-lg " color-on-scroll="500">
        <div class="container-fluid">
            <a class="navbar-brand" style="margin-top: 0" href="#pablo"> Users <i class="nc-icon nc-palette"></i></a>
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
                ...
                <script>
                    function Search() {
                        ...
                        document.getElementById("search").href = '/QuanLyDuLich-Spring/admin/users?username='+input.value
                    }
                </script>
