...
<div class="sidebar" data-color="blue" data-image="../resources/assets/img/sidebar.jpg">
...
<div class="main-panel">
    ...
    <div class="container" style="height: 81%">
        <div class="card h-100" style="max-height: 38%; margin-top: 5%">
            <c:if test="${param.error != null}">
                <div class="alert alert-danger">
                    Đã có lỗi xảy ra!
                </div>
            </c:if>
            <c:url value="/admin/signin" var="action" />
